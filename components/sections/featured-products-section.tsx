  ...
  return (
    <section id="services" className="relative bg-background py-20 md:py-32">
      <div className="px-4 md:px-12 lg:px-20">
        <div className="mx-auto mb-10 flex max-w-7xl items-end justify-between gap-6 md:mb-14">
          <div>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 translate-y-full bg-linear-to-t from-black/70 to-transparent px-5 pb-5 pt-12 transition-transform duration-500 ease-out group-hover:translate-y-0">
                ...
                <p className="mt-1 text-sm font-medium text-white">Project detail {String(index + 1).padStart(2, "0")}</p>
              </div>
            </div>
          ))}
        </div>
