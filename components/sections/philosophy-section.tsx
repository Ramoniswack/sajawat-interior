      ...
      <div ref={descriptionRef} className="px-6 pt-8 pb-20 md:px-12 md:pt-12 md:pb-28 lg:px-20 lg:pt-16 lg:pb-36">
        <div className="text-center">
          ...
          <p className="mt-8 leading-relaxed text-muted-foreground text-3xl text-center">
            {("Sajawat Interior brings considered design to homes, hospitality, and workspaces across Damauli. We pair tactile materials, warm light, and practical planning to create interiors that feel distinctly yours.").split(" ").map((word, index, array) => {
