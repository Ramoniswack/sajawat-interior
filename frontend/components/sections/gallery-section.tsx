...
export function GallerySection() {
  ...
  const images = [
    { src: "/images/luxury-living-room.png", alt: "Luxury living room interior" },
    { src: "/images/luxury-dining-room.png", alt: "Luxury dining room interior" },
    { src: "/images/luxury-bedroom.png", alt: "Luxury bedroom interior" },
    { src: "/images/luxury-kitchen.png", alt: "Luxury kitchen interior" },
  ];
